...
// fe ♏ |作者：吴翔宇| 🍁 |日期：2022/11/19|
//
// fe fe是一个基本元素表达式，它本质是一个长度为6的uint64数组，长度为384bit。
type fe [6]uint64

// fe2 ♏ |作者：吴翔宇| 🍁 |日期：2022/11/19|
//
// fe2 是'fp2'的元素表示，它是基场'fp'的二次扩展 表示遵循c[0] + c[1] * u的编码顺序。
type fe2 [2]fe

// fe6 ♏ |作者：吴翔宇| 🍁 |日期：2022/11/19|
//
// fe6 是'fp6'场的元素表示，它是'fp2'的立方体扩展表示，遵循c[0] + c[1] * v + c[2] * v^2编码顺序。
type fe6 [3]fe2

// fe12 ♏ |作者：吴翔宇| 🍁 |日期：2022/11/19|
//
// fe12 是'fp12'字段的元素表示，它是'fp6'的二次扩展 表示遵循c[0] + c[1] * w的编码顺序。
type fe12 [2]fe6
